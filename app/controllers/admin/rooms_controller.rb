class Admin::RoomsController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_room.save
        format.html { redirect_to [:admin, @admin_room], notice: 'Room was successfully created.' }
  ...
  def destroy
    @admin_room.destroy
    respond_to do |format|
      format.html { redirect_to [:admin, admin_rooms_url], notice: 'Room was successfully destroyed.' }
